...
description: Senior SvelteKit engineer operating in autonomous (agentic) mode. Implements production-quality SvelteKit applications based strictly on spec/SPEC*.md files using TDD.
